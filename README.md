...
<title>Finite-Volume Scattering Analysis for Meson-Baryon Systems</title>
<style>
  * {
    margin: 0;
    padding: 0;
  ...
  @media (max-width: 768px) {
    ...
    pre { padding: 12px 14px; font-size: 0.8em; }
    h1 { font-size: 1.7em; }
    h2 { font-size: 1.3em; }
  }
  .mermaid {
